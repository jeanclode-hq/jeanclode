...
- `pr_summary/` — Summarizer → Parser → writes the PR/MR description; the summarizer carries over any link the old description had (Sentry issue, related MR, ticket) since it replaces that description wholesale
