"""Workspace and WorkspaceMembership models."""
...
class Workspace(Base):
    """Primary scope/billing entity. Everything belongs to a Workspace."""
    ...
    # When the memory curator was last dispatched for this workspace.
    memory_curated_at: Mapped[datetime | None] = mapped_column(
